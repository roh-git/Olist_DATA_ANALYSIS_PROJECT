...
- `docs/STORYLINE_REVISED.md`: 검증 결과를 반영한 상세 스토리라인
- `docs/RFM_ADDITIONAL_CODE_GUIDE.md`: RFM 이후 코드에 대한 비전공자용 설명
- `ANALYSIS_CHANGELOG.md`: 데이터 정제 및 군집화 변경 이력
- `docs/STORYLINE_ANALYSIS_REVIEW.md`: 초기 분석 검토 기록
